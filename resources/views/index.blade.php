            ...
            <div class="col-md-2 bandeau-pub text-center  animated bounceInRight">
                <div class="JsonConnexion">
                    ...
                    @foreach($users as $user)
                        <p>
                            <img style="border:1px solid #007791;" class="img-fluid"
                                 src="{{asset('images/Users/default.png')}}" alt="Image de profil"><br>
                            <a style="text-decoration: none; font-size: 0.9em; color:#007791;"
                               href="/profil/{{ $user->firstname }}"> {{$user->name}}&nbsp;{{$user->firstname}}</a><br/>
                        </p>
                    @endforeach
                </div>
                <img class="img-fluid"
