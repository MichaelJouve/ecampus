    ...
    <div class="container">
        <div class="row align-items-center ">
            ...
            <div class="col-xl-1 col-lg-1 col-md-1 col-sm-12 col-xs-12 text-center">
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenu2">
                            ...
                            <a href="{{URL::route('front_listing_categorie')}}/{{$category->name}}">
            ...
            <div class="col-xl-3 col-lg-4 col-md-5 col-sm-12 col-xs-12 text-center header-link">
                ...
                <a href="Pages/connexion.html" class="btn btn-light" title="Connectez-vous!" data-toggle="modal"
                   data-target="#ModalConnexion">Connexion</a>
                <a href="Pages/inscription.html" class="btn btn-primary" title="Inscrivez-vous!" data-toggle="modal"
                   data-target="#ModalInscription">S'inscrire</a>
            </div>
        </div>
    </div>
</header>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form class="col-sm-12" method="POST" id="form_inscription" action="Pages/inscription_membre.php">
                    <input type="text" id="nom" name="nom" placeholder="Nom" nb_min="2" nb_max="15"
                           title="Entre 2 et 15 caractères">
                    <input type="text" id="prenom" name="prenom" placeholder="Prenom" nb_min="2" nb_max="15"
                           title="Entre 2 et 15 caractères">
                    <input type="text" id="datenaissance" name="datenaissance" class="form-control datepicker"
                           placeholder="14/09/1989" title="Il faut ta date de naissance">
                    <input type="email" id="email_inscription" name="email" placeholder="Adresse email"
                           title="Il faut une adresse E-mail valide">
                    <input type="password" id="password_inscription" name="password" placeholder="Mot de passe"
                           title="Entre 8 et 20 caractères, 1 majuscule, 1 minuscule et 1 chiffre">
                    <input type="password" id="confirm-password_inscription" name="confirm-password"
                           placeholder="Confirmation mot de passe" title="Confirmation du mot de passe">
                    <input type="button" class="btn btn-primary btn-lg btn-block" id="submit_inscription"
                           value="S'inscrire">
                    <div class="input-group-text mt-2" id="check_cgu">
                        <input type="checkbox" id="checkbox">
                        <h6>En vous inscrivant, vous acceptez nos <a href="{{URL::route('front_cgu')}}">conditions
                                générales d'utilisation.</a></h6>
                    </div>
                </form>
