...
@section('contenu')
    <div class="container-fluid pt-4 pb-4 bandeau-sombre">
        <div class="container">
            ...
            <p><b> {{ $publication->user->firstname }}</b>, vous allez modifier le post suivant : <u><b>{{ $publication->title }}</b></u> !</p>
        </div>
    </div>
        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="ajout-post" method="POST" action="{{URL::route('update-publication', ['slug' => $publication->slug])}}">
                            @csrf
