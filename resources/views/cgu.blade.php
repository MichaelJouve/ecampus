                ...
                <div class="col-8">
                    ...
                    <div class="card border-primary ">
                        ...
                        <div class="card-body text-primary">
                            ...
                            <p>[Nom du site] se réserve le droit de modifier unilatéralement et à tout moment le contenu des présentes conditions générales d'utilisation.</p>
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="card border-primary ">
                        ...
                        <div class="card-body text-primary">
                            <p class="card-text">
                            <p>L'édition du site [Nom du site] est assurée par la Société [Nom de la société] [SAS / SA / SARL, etc.] au capital de [montant en euros] € dont le siège social est situé au [adresse du siège social].</p>
                            <p>[Le Directeur / La Directrice] de la publication est [Madame / Monsieur] [Nom & Prénom].</p>
                            <p>Éventuellement :</p>
                            <p>[Nom de la société] est une société du groupe [Nom de la société] [SAS / SA / SARL, etc.] au capital de [montant en euros] € dont le siège social est situé au [adresse du siège social].</p>
                            <p>L'hébergeur du site [Nom du site] est la Société [Nom de la société] [SAS / SA / SARL, etc.] au capital de [montant en euros] € dont le siège social est situé au [adresse du siège social].</p>
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="card border-primary ">
                        ...
                        <div class="card-body text-primary">
                            ...
                            <p>Tout événement dû à un cas de force majeure ayant pour conséquence un dysfonctionnement du réseau ou du serveur n'engage pas la responsabilité de [Nom du site].</p>
                            ...
                            <p>L'Utilisateur a la possibilité de contacter le site par messagerie électronique à l’adresse [contact@nomdusite.com].</p>
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="card border-primary ">
                        ...
                        <div class="card-body text-primary">
                            ...
                            <p>Le site assure à l'Utilisateur une collecte et un traitement d'informations personnelles dans le respect de la vie privée conformément à la loi n°78-17 du 6 janvier 1978 relative à l'informatique, aux fichiers et aux libertés. Le site est déclaré à la CNIL sous le numéro [numéro].</p>
                    ...
                    <div class="card border-primary ">
                        ...
                        <div class="card-body text-primary">
                            <p class="card-text">
                            <p>De nombreux liens hypertextes sortants sont présents sur le site, cependant les pages web où mènent ces liens n'engagent en rien la responsabilité de [Nom du site] qui n'a pas le contrôle de ces liens.</p>
                    ...
                    <div class="card border-primary ">
                        ...
                        <div class="card-body text-primary">
                            <p class="card-text">
                            <p>La durée du présent contrat est indéterminée. Le contrat produit ses effets à l'égard de l'Utilisateur à compter de l'utilisation du service.</p>    </p>
                        </div>
                    </div>
                    ...
                    <div class="card border-primary ">
                        ...
                        <div class="card-body text-primary">
                            ...
                            <p>CGU d'un site internet (conditions générales d'utilisation) en PDF
                                Pour transformer votre modèle de contrat « CGU d'un site internet (conditions générales d'utilisation) » en PDF, utilisez le logiciel de traitement de texte gratuit LibreOffice ou OpenOffice, qui permet de faire directement la conversion de word à PDF. Si vous utilisez une version récente de Word, vous pouvez aussi créer un PDF avec la fonction « enregistrer sous ».</p>
                            </p>
                        </div>
                    </div>
