                ...
                <div class="card border-primary ">
                    ...
                    <div class="card-body text-primary">
                        ...
                        <p>En outre, il est conforme aux dispositions de la Loi 78-17 du 6 janvier 1978 relative à
                            l'informatique, aux fichiers et aux libertés. En vertu de celle-ci l'Utilisateur bénéficie
                        ...
                        <p>Pour faire usage de celui-ci, l'Utilisateur doit s'adresser à l'Éditeur en le contactant à
                            l'adresse suivante : ecampus@ecampus.fr, ou par courrier adressé au domicile de l'Éditeur en
                ...
                <div class="card border-primary ">
                    ...
                    <div class="card-body text-primary">
                        ...
                        <p>Le site {e}campus.com a
                            ...
                            confort de
                            l'Utilisateur.</p>
                        <p>Conformément à la législation européenne, le site {e}campus.com a mis à jour sa politique de
                            confidentialité en
                            matière de cookies. L'Utilisateur est libre d'accepter ou de refuser les cookies de tous les
                ...
                <div class="card border-primary ">
                    ...
                    <div class="card-body text-primary">
                        ...
                        <p>Pour tout signalement de contenus ou d'activités illicites, l'Utilisateur peut contacter
                            l'Éditeur à
                            l'adresse suivante : ecampus@ecampus.fr, ou par courrier recommandé avec accusé de réception
                            adressé
